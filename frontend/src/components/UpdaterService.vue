<template>
    <div v-if="showUpdateBanner"
        ...
        <span class="text-base-content text-xs">New version {{ latestVersion }} available!</span>
        <div class="flex flex-row items-center gap">
            <button class="btn btn-ghost btn-xs" @click="downloadAndInstall" :disabled="isUpdating">
